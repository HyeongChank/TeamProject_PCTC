...
import com.example.pctcback.dto.Oauth2.GoogleOAuth2UserInfo;
import com.example.pctcback.dto.Oauth2.KaKaoOAuth2UserInfo;
import com.example.pctcback.dto.Oauth2.NaverOAuth2UserInfo;
import com.example.pctcback.dto.Oauth2.OAuth2UserInfo;
...
public class OAuthAttributes {
     ...
     * role은 GUEST로 설정
     */
    public User toEntity(AuthProvider socialType, OAuth2UserInfo oauth2UserInfo) {
        return User.builder()
